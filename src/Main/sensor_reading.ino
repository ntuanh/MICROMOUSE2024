...
void laser_processing() {
  ...
  //
  if ( avgFront < limit ) wallFront = true  ; else wallFront = false ;
  if ( avgLeft < limit ) wallLeft = true  ; else wallLeft = false  ;
  if ( avgRight < limit ) wallRight = true  ; else wallRight = false ;
  //
